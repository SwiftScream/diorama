...
No implementation unit has started.
...
Review-unit IDs use phase letters A through J and local numbers, including D01–D05 for interception evidence.
...
| -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [DD01: Common abstraction](../design-decisions/01-common-abstraction.md)                     | Independently ordered typed tracks in a heterogeneous scenario; repeated system instances have separate attachment keys. B01–B05, E04–E08, J03.                                                                                                                                      |
| [DD02: Ownership layers](../design-decisions/02-shared-vs-system-semantics.md)               | Whole-attachment mode overrides; public system services; domain and adapter boundaries. B01–B07, E08, H02–H04, I01.                                                                                                                                                                  |
| [DD03: Recorded behaviors](../design-decisions/03-recorded-behaviors.md)                     | Mutually exclusive grouped conclusions, explicit open horizons, capability-specific timing, observed/override normalization. E04–E07, F01–F05, G03–G06, H05–H14.                                                                                                                     |
| [DD04: Selection](../design-decisions/04-replay-selection.md)                                | Stable inputs, deterministic system selectors, FIFO among equivalent candidates, explicit ambiguity and no live replay fallback. B04, E05, H04, H14, I01–I09.                                                                                                                        |
| [DD05: Consumption and verification](../design-decisions/05-consumption-and-verification.md) | Whole groups claimed once at selection; usage differs from completion; retention precedes sink; immutable reports have no test outcome; later diagnostics remain separately inspectable. B02, B04, B08, E05–E06, J01–J03. DD15 supersedes the old example of persisted clock sleeps. |
| [DD06: Stable conversion](../design-decisions/06-runtime-to-snapshot-conversion.md)          | Reserve order and needed time at observation; detach native values in their valid isolation; preserve live results on late conversion failure and refuse unhealthy publication. B02–B04, C06, G08, I01–I08.                                                                          |
| [DD07: Persistence](../design-decisions/07-persistence-boundary.md)                          | Optional at the core; load once; replace whole healthy candidates; preserve untouched baseline tracks; logical atomicity and last writer wins. C01–C07, H07.                                                                                                                         |
| [DD08: Schema compatibility](../design-decisions/08-schema-compatibility.md)                 | Independent positive envelope/system versions, explicit registration, strict first-party fields, deterministic JSON, no POC importer. C01–C04, F02, G03, H02–H13.                                                                                                                    |
| [DD09: Preparation](../design-decisions/09-normalization-and-redaction.md)                   | Structural canonicalization, redaction, normalization, validation before admission, including decoded input and resources. Immutable setup policy; match projection is separate. B02, C02, G06, H03–H04, H07–H08.                                                                    |
| [DD10: Lifecycle](../design-decisions/10-lifecycle-and-ownership.md)                         | Immutable definitions, fresh executions, ordered activation and reverse rollback, explicit idempotent finish, body outcome plus final report, quiescence, lightweight post-finish reporter independent of execution resources. B02–B03, B08–B09, C04–C06, E03, G09, I08.             |
| [DD11: HTTP domain](../design-decisions/11-http-model-strategy.md)                           | HTTP Types currency only in optional HTTP products; Diorama owns fields, bodies, policies, schema; native semantics remain in adapters. H01–H14.                                                                                                                                     |
| [DD12: URLSession](../design-decisions/12-urlsession-scope.md)                               | Per-session interception, supported HTTP(S) data tasks, early rejection in all modes, redirects and Basic/Digest, tested platform profiles. D01–D05, I01–I09; ordering gate Q1 applies.                                                                                              |
| [DD13: Random](../design-decisions/13-random-proving-system.md)                              | Reference-semantic generator, ordered raw UInt64, no timestamps, injected live source, zero after diagnosed exhaustion, public-only implementation. B01–B08, C07.                                                                                                                    |
| [DD14: Scheduler](../design-decisions/14-real-time-replay-scheduler.md)                      | One execution-owned ContinuousClock, one-to-one delays, deterministic handoff, no registration reentrancy, atomic cancel/claim, delivery acknowledgement. E01–E08; availability gate Q2 applies.                                                                                     |
| [DD15: Clock](../design-decisions/15-clock-system.md)                                        | Millisecond wall origins and signed successive deltas; positional overrides; empty wall payload; nonpersisted monotonic Clock. F01–F07.                                                                                                                                              |
| [DD16: Location](../design-decisions/16-location-system.md)                                  | Portable async replay, origin-relative WGS84 measurements, separate delivery time, access barriers, nonterminal failures, narrow Apple facade. G01–G09.                                                                                                                              |
| [DD17: HTTP composition](../design-decisions/17-http-lifecycle-composition.md)               | One recursive tree, embedded typed supplements, exact bodies once, weighted delivery, conditional derived length, local delays and timing-only override merge. H05–H14, I01–I09.                                                                                                     |
| [Overview](../design-overview.md)                                                            | Ignoring an attachment changes verification only: it never bypasses persistent registration, preparation, or schema validation. C01–C06, J03.                                                                                                                                        |
| [Dependency policy](../dependency-policy.md)                                                 | Candidate status is not adoption approval. Tools and HTTP products need exact reviewed adoption records before use. A02, H01, and any later demonstrated need.                                                                                                                       |
| [Quality policy](../quality-gates-and-ci.md)                                                 | One complete tooling/CI bootstrap review unit, warning-free strict concurrency, all applicable platforms, required Codecov uploads. A01–A04, B10, every subsequent code unit.                                                                                                        |

Further interpretations that must survive implementation:

- Stable track order does not impose global call order.
  A cancelled, open, or partially delivered claim remains used and never returns to availability.
...
D01–D05 cover all six required spike questions.
The H/I production breakdown can therefore be reviewed now and remains provisional until D05 confirms or revises it against the evidence.
...
A01 must verify these minima with the selected stable toolchain.
...
B02/B03 implement the reporting and ownership boundary; B08 verifies the concurrent freeze boundary and unchanged final result.
...
DD16 specifies WGS84 origins and east/north metres but leaves the mapping algorithm, constants, singularities, and useful numerical error bounds to be fixed as part of the stable codec.
G02 supplies independent numerical evidence and a proposed contract before G03 encodes it.
...
G01/G03 and H09 must document these before native capture depends on them.
...
A01 selects exact latest-stable Swift/Xcode versions at bootstrap, the macOS CI host, iOS simulator destination, and Linux distribution, architecture, official Swift toolchain/container, and libcurl version.
Record how libcurl is fixed or bounded and revalidated.
No floating “latest” value in this plan is a version pin.
A02 fixes tool adoptions, H01 fixes HTTP package adoption, and B10 confirms numeric coverage thresholds against real coverage.
Codecov authentication/account configuration must be available for A04's required uploads; lack of it is a reported gate, not a reason to weaken CI.
...
1. Confirm that the plan and selected unit are authorized, its prerequisites are reviewed, and its gates are resolved.
   Inspect branch and worktree; use one feature branch for that review unit and preserve unrelated changes.
2. Provide a summary of the work that will be undertaken and pause for feedback from the owner.
   Do not continue until the owner has explicitly confirmed.
   This is a final chance for the owner to adjust the plan before the work proceeds.
...
| ----- | ------------ | ---------------------------------------------------------------------------- |
| A     | A01–A04      | Toolchain/approval evidence, minimal package, complete quality bootstrap.    |
| B     | B01–B10      | Public sequential core and an in-memory random system.                       |
| C     | C01–C07      | Persisted random and consumer-defined systems; first complete vertical path. |
| D     | D01–D05      | Isolated URLProtocol evidence and reviewed native capability boundaries.     |
| E     | E01–E08      | Shared real-time scheduler and reusable grouped behavior services.           |
| F     | F01–F07      | Complete portable clock system.                                              |
| G     | G01–G09      | Portable location replay and narrow Apple live/delegate integration.         |
| H     | H01–H14      | Shared HTTP domain, resource publication, strict URLSession lifecycle data.  |
| I     | I01–I09      | Incremental production URLSession conformance across platform bridges.       |
| J     | J01–J04      | Opt-in test integrations, combined-system acceptance, user documentation.    |
...
Under resolved Q1, the provisional HTTP/URLSession production breakdown is confirmed or revised against reviewed spike evidence at D05 before production work depends on that boundary.
...
### A01 — Toolchain and deployment feasibility record

- Prerequisites: Plan authorization; quality policy, DD14–DD16, Q2/Q5.
- Scope: Identify exact latest-stable toolchains and platform matrix; verify clock availability at the newly approved deployment minima from Q2.
- Expected files/modules: `docs/evidence/toolchain-and-availability.md`; isolated availability probes under `Spikes/ToolchainAvailability/`.
...
- Exclusions: Package-wide availability increases, substitute clocks, runtime architecture, installing production dependencies, selecting beta toolchains.
...
### A02 — Quality-tool adoption records

- Prerequisites: A01; dependency and quality policies.
...
### A03 — Minimal package skeleton

- Prerequisites: A01 and resolved deployment selections; quality policy.
...
- Checkpoint: R; review only the buildable skeleton.
  Feature work waits for A04.

### A04 — Canonical quality and CI bootstrap

- Prerequisites: A02 adoption approval, A03, quality policy, Q5 configuration.
...
- Exclusions: Runtime architecture, tool dependencies in library targets, assertion-free coverage padding, invented final thresholds before B10.
- Checkpoint: R; require complete bootstrap evidence before B01.
...
### B01 — Typed scenario definitions and track identity

- Prerequisites: A04; DD01–DD04, DD10, DD13.
...
### B02 — Prepared admission, safe diagnostics, and health

- Prerequisites: B01; DD05–DD06, DD09–DD10; resolved Q3 reporting contract.
...
### B03 — Execution activation and sequential lease lifetime

- Prerequisites: B01–B02; DD10, DD13; resolved Q2/Q3 contracts.
...
### B04 — Atomic public sequential record and replay operations

- Prerequisites: B03; DD04–DD06, DD13.
...
### B05 — Consumer-module extension proof

- Prerequisites: B04; DD02, DD13.
...
### B06 — Random live recording and passthrough

- Prerequisites: B05; DD13, DD06, DD09.
...
- Exclusions: Replay implementation (explicitly unavailable until B07), seeds, distributions, cryptographic claims, clocks and native adapters.
- Checkpoint: R; review public-only implementation and source ownership.

### B07 — Random replay and deterministic failure

- Prerequisites: B06; DD05, DD13.
...
### B08 — Concurrent finalization and report evaluation

- Prerequisites: B07; DD05, DD10, DD13; resolved Q3 contract.
...
- Tests/verification: V-code; body success/error/cancellation, failing cleanup, cancelled waiter, explicit versus scoped intent, source/result diagnostics.
- Exclusions: Test-framework hooks, inferring test failure from a sink, durable writes before C05, new publication modes beyond DD10.
- Checkpoint: R; review ergonomic API and both-outcome error presentation.

### B10 — First production coverage baseline

- Prerequisites: B08–B09 and A04 platform uploads; quality policy, Q5.
...
### C01 — Persistent-system registration and version dispatch

- Prerequisites: B08; DD07–DD09.
...
### C02 — Deterministic version-one JSON and random schema

- Prerequisites: C01, B07; DD08–DD09, DD13.
...
### C03 — Single-document atomic file repository

- Prerequisites: C02; DD07–DD08.
...
- Exclusions: Public flush, per-event durable append, locking for the duration of recording, optimistic revisions, multi-file publication before H07.
- Checkpoint: R; review atomicity evidence and documented backend limitations.

### C04 — Baseline loading before activation

- Prerequisites: C03, B03; DD07–DD10.
...
### C05 — Complete candidate replacement and final publication

- Prerequisites: C04, B08–B09; DD07, DD10, DD13.
...
### C06 — Publication failures and actionable reports

- Prerequisites: C05; DD05–DD10.
...
### C07 — Persisted consumer-system and random conformance

- Prerequisites: C06, B05–B07; DD13, DD07–DD08.
...
Under resolved Q1, D05 confirms or revises the provisional H/I breakdown against reviewed evidence before production work depends on the proposed boundary.

### D01 — Bodyless GET interception and routing spike

- Prerequisites: C07, A01; DD12, DD17, Q1.
...
### D02 — Task rejection and response-presentation spike

- Prerequisites: D01; DD12 response/task/delegate sections, DD17.
...
### D03 — Redirect correlation spike

- Prerequisites: D02; DD12/DD17 redirect contracts.
...
### D04 — Basic and Digest challenge spike

- Prerequisites: D02; DD12/DD17 authentication and credential contracts.
...
### D05 — Native quiescence and consolidated feasibility gate

- Prerequisites: D01–D04; DD10, DD12, DD14, DD17.
...
- Exclusions: Cancelling consumer-owned live work to pass teardown, timeout-based claims of quiescence, production promotion of the spike, hiding lost phases.
...
### E01 — Execution logical-time and capture service

- Prerequisites: C07, A01; DD03, DD06, DD14; Q2 resolved.
...
### E02 — One-to-one deadline engine and deterministic handoff

- Prerequisites: E01; DD14.
...
### E03 — Cancellation, acknowledgements, and scheduler quiescence

- Prerequisites: E02, B08; DD10, DD14.
- Scope: Complete scheduled-item pending/claimed/delivered/cancelled state and execution shutdown, including in-flight delivery acknowledgement.
...
- Tests/verification: V-code; cancel-before/after-claim, earliest-item cancellation, no double resume, callback reentry, attempted rescheduling during finish, cancelled finish waiter, no scheduled delivery after final result on all platforms; new misuse diagnostics do not restart scheduling.
...
### E04 — Strict grouped lifecycle accumulation

- Prerequisites: E01, B04, B08; DD03, DD06, DD10.
...
### E05 — System selectors and atomic grouped claims

- Prerequisites: E04, B04, B08; DD04–DD05.
...
### E06 — Sequential stream delivery over grouped claims

- Prerequisites: E03–E05; DD03–DD05, DD14.
...
### E07 — Conditional interaction delivery

- Prerequisites: E03–E05; DD03–DD04, DD14, DD17 timing refinement.
...
### E08 — External scheduling and mixed-mode conformance

- Prerequisites: E06–E07; DD02, DD06, DD10, DD14.
...
### F01 — Shared millisecond duration and ISO 8601 codecs

- Prerequisites: C02; DD08, DD15; A01 selected platform matrix.
...
### F02 — Empty and nonempty wall recordings

- Prerequisites: F01, C01–C02; DD03, DD08, DD15.
...
### F03 — Wall-source recording and passthrough

- Prerequisites: F02, B04; DD06, DD09, DD15.
...
### F04 — Sequential wall replay and exhaustion

- Prerequisites: F03, B08; DD05, DD15.
...
### F05 — Clock override normalization and re-record merge

- Prerequisites: F04, C05; DD03, DD07, DD09, DD15.
...
### F06 — Logical Swift Clock facet and closed-handle behavior

- Prerequisites: F04, E08; DD14–DD15.
...
- Public behavior: Instants are Duration offsets without execution identity; receiving executions interpret transferred offsets locally.
  ...
  Finish cancels pending sleeps and freezes now; new closed sleeps diagnose and throw execution-closed, while cancelled pending sleeps throw CancellationError.
...
### F07 — Clock platform and complete-system conformance

- Prerequisites: F05–F06; DD15.
...
### G01 — Portable location, access, and failure values

- Prerequisites: F01, B02; DD06, DD09, DD16, Q4.
...
### G02 — WGS84 mapping and numerical contract evidence

- Prerequisites: G01; DD16 coordinate/scalar sections, dependency policy, Q4.
...
- Checkpoint: R; resolve Q4 and any dependency/decision changes before G03.

### G03 — Location version-one codec and strict recording model

- Prerequisites: G02 approved mapping, C02, F01; DD03, DD08, DD16.
...
### G04 — Portable sequential update replay

- Prerequisites: G03, E06; DD04–DD05, DD16.
...
### G05 — Access state notifications and authorization barriers

- Prerequisites: G04, E03; DD16 access/request contracts.
...
### G06 — Location origin policy and re-record replacement

- Prerequisites: G03–G05, F05, C05; DD09, DD16.
...
### G07 — Main-actor delegate facade over portable replay

- Prerequisites: G04–G05; DD16 consumer and escaped-handle contracts.
...
### G08 — Private Core Location capture and live forwarding

- Prerequisites: G06–G07, B02, E01; DD06, DD09, DD16.
...
### G09 — Location shutdown and cross-platform acceptance

- Prerequisites: G08; DD10, DD14, DD16.
...
Under resolved Q1, its provisional units can be reviewed now; D05 must confirm or revise the affected breakdown against spike evidence before production implementation proceeds.
Add only the shared boundaries actually needed by URLSession; do not build an AsyncHTTPClient adapter to justify them.

### H01 — Swift HTTP Types adoption record

- Prerequisites: A01, C07, D05 reviewed under resolved Q1; DD11, dependency policy.
...
- Checkpoint: R plus explicit adoption approval; stop before H02 changes manifests.

### H02 — Shared message heads, fields, and body values

- Prerequisites: H01 adoption approval, C02; DD08, DD11, DD17.
...
### H03 — Typed HTTP preparation and credential defaults

- Prerequisites: H02, B02; DD09, DD11, DD17.
...
### H04 — Standard HTTP matcher and safe differences

- Prerequisites: H03, E05; DD04, DD09, DD11.
...
### H05 — Strict response/body/failed/open lifecycle

- Prerequisites: H02, E04, F01; DD03, DD11, DD17.
...
- Exclusions: Redirect/authentication/disposition nodes until H10–H12, synthetic completion for open work, informational 1xx/wire-level behavior.
- Checkpoint: R; review runtime validity separately from native delivery.

### H06 — Weighted body allocation and local timing

- Prerequisites: H05; DD14, DD17, F01.
...
### H07 — Atomic resources with the first resource-backed consumer

- Prerequisites: H02–H03, H05–H06, C03–C06; DD07–DD09, DD17.
...
### H08 — Exact JSON resources and derived Content-Length

- Prerequisites: H07, H06; DD11, DD17.
...
### H09 — Stable URLSession failure supplements

- Prerequisites: H05, B02, D02/D05 evidence; DD12, DD17, Q4.
...
### H10 — Response-owned redirect branches

- Prerequisites: H05–H06, H09, D03 reviewed; DD17.
...
- Checkpoint: R; review structural ownership against D03 native evidence.

### H11 — Response-owned authentication branches

- Prerequisites: H10, D04 reviewed; DD09, DD12, DD17.
...
### H12 — Optional response-disposition supplement

- Prerequisites: H05, H09, D02 reviewed; DD12, DD17.
...
### H13 — Full lifecycle validation, registration, and capability derivation

- Prerequisites: H08–H12, E05/E07, C01; DD08, DD11–DD12, DD17.
...
### H14 — HTTP timing-override correspondence and re-recording

- Prerequisites: H13, H04, F05, C05; DD03–DD04, DD09, DD17.
...
### I01 — Instrumented session and bodyless GET vertical path

- Prerequisites: D05 evidence review, H13–H14, E08; DD10, DD12, DD17, resolved Q1.
...
### I02 — In-memory bodies and aggregate data-task presentations

- Prerequisites: I01, H08; DD11–DD12, DD17.
...
### I03 — Native failure record/replay

- Prerequisites: I02, H09; DD06, DD12, DD17.
...
### I04 — Segmented delegate delivery and response disposition

- Prerequisites: I03, H06/H12, D02 evidence; DD12, DD17.
...
### I05 — Native redirects and recursive request derivation

- Prerequisites: I04, H10, D03 evidence; DD12, DD17.
...
- Public behavior: Automatic or delegate follow/modification/refusal selects the recorded compatible branch.
  Preserve the response/request ownership from H10; unanswered decisions remain open and mismatches fail without network access.
- Tests/verification: V-code; all D03 cases including multi-hop, relative target, method/body rewrite, cross-origin credential preparation, loops/limits, refusal body, open branches, modified-request matching, current-decision timing, cancelled/finished redirect and routing continuity without stable route data.
...
### I06 — Native HTTP Basic authentication

- Prerequisites: I05, H11, D04 evidence; DD12, DD17.
...
- Exclusions: Digest until I07, Security objects, response-less challenges, storing a real password to make native replay work, implementing Basic itself.
- Checkpoint: R; review Basic end-to-end fidelity and secret-marker tests.

### I07 — Native HTTP Digest authentication

- Prerequisites: I06, D04 Digest evidence; DD12, DD17.
...
### I08 — Full open-horizon and native ownership conformance

- Prerequisites: I07; DD03, DD05, DD10, DD12, DD14, DD17.
- Scope: Broaden the lifecycle protection present since I01 across every native phase and open state, with failure/cancellation/re-record integration.
...
- Tests/verification: V-code; finish at every phase, repeated/concurrent/cancelled finish waiters, no replay callbacks after quiescence, late live results forwarded without candidate mutation, source/session ownership, routing/lease release, used/incomplete facts and healthy explicit-open persistence.
- Exclusions: Cancelling live work merely to reach a horizon, leak masking through global strong registries, recording caller cancellation, new timeout policy.
- Checkpoint: R; review production shutdown evidence independently from happy paths.

### I09 — Complete URLSession capability and cross-bridge matrix

- Prerequisites: I08, H13–H14; DD11–DD12, DD17.
...
### J01 — Opt-in XCTest integration

- Prerequisites: B08–B09, C06; DD05, DD10, resolved Q3, quality policy.
...
### J02 — Opt-in Swift Testing integration

- Prerequisites: J01's reviewed common integration policy, B09, C06; DD05, DD10.
...
### J03 — Combined-system acceptance suite

- Prerequisites: C07, E08, F07, G09, I09, J01–J02.
...
### J04 — User documentation and initial delivery review

- Prerequisites: J03 and every required unit's acceptance evidence.
...
- Tests/verification: V-doc and final accepted V-code evidence from J03; compile public examples, audit dependency adoption records/products and schema readers, ensure every promised capability links to tests and every exclusion is visible.
